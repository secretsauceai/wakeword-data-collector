from wakeword_collector.functions import collect_background_noise, collect_user_data, zipfiles, pyaudio_start, pyaudio_terminate, make_directories
from wakeword_collector.collect_wakeword_cli import collect_wakeword_part_one_cli, collect_wakeword_part_two_cli, collect_wakeword_part_three_cli
from wakeword_collector.collect_non_wakeword_cli import collect_non_wakeword_cli
from wakeword_collector.collect_wakeword_variations_cli import collect_wakeword_variations_cli
from wakeword_collector.collect_random_cli import collect_random_cli
from wakeword_collector.collect_all_partial_wakeword_cli import collect_all_partial_wakeword_cli
